        ...
        ***********************************-->
        			<div class="content-body">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    {
                                        $result=mysqli_query($conn,"delete from tbl_case_docu where docu_id='".$_POST["deleteid"]."'");
                                    ...
                                    <table id="example3" class="display table-responsive-lg">
                                        ...
                                        <tbody>
                                             <?php
                          $count=1;
                          $result=mysqli_query($conn,"select * from tbl_case_docu") or die(mysqli_error($conn));
                        ...
                        <tr>
                            ...
                            <td><?php echo $row["docu_upload"]; ?></td>
