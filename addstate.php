                    ...
                    <div class="container-fluid">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Input State Information</h4>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <?php 
                                        ...
                                        {
                                            $result = mysqli_query($conn,"insert into tbl_state (state_name) values ('".$_POST["txtstatename"]."')") or die(mysqli_error($conn));
                                            if($result==true)
                                        {
                                            ?>
                                    ...
                                    <form method="post" id="form1">
                                        ...
                                        State name :
                                           <input type="text" name="txtstatename" class="form-control input-rounded">
                                        </div>
                                        <div class="form-group">
                                <div class="col-sm-8">
