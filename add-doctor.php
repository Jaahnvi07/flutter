                  ...
                  <button type="button" class="close h-100" data-dismiss="alert" aria-label="Close"><span><i class="mdi mdi-close"></i></span>
                    ...
                    <div class="form-group">
                       Email<input type="email" name="txtemail" class="form-control input-rounded">
           					...
           					<div class="form-group">
           						 UserName<input type="text" name="txtuname" class="form-control input-rounded">
           					</div>
           					<div class="form-group">
                    ...
                    <div class="form-group">
                       Landmark<input type="text" name="txtlan" class="form-control input-rounded">
                    </div>
                     <div class="form-group">
