...
<head>
    ...
    <title>View Comment - Admin</title>
    <!-- Favicon icon -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    {
                                        $result=mysqli_query($conn,"delete from tbl_comment where com_id='".$_POST["deleteid"]."'");
                                    ...
                                    <table id="example3" class="display table-responsive-lg">
                                        ...
                                        <tbody>
                                             <?php
                          $count=1;
                          $result=mysqli_query($conn,"select c.*,a.description,u.fname from tbl_comments as c left join tbl_article as a on a.ar_id=c.ar_id left join tbl_userr as u on u.user_id=c.user_id") or die(mysqli_error($conn));
                        ...
                        <tr>
                            ...
                            <td>
                                                    <div class="d-flex">
                                                        ...
                                                        <a data-id="<?php echo $row["ar_id"]; ?>" data-toggle="modal" data-target="#basicModal"  class="btn btn-danger shadow btn-xs sharp open-dialog"><i class="fa fa-trash"></i></a>
                                                    </div>                                 
                                                </td>
                        </tr>
