					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <button name="btnadd" type="button" onclick="window.location='addcategory.php';" class="btn btn-rounded btn-primary"><span
                        ...
                        <tr>
                            ...
                            <td><a target="_blank" href="uploads/category/<?php echo $row["category_img"]; ?>">
                                    <img width="100" height="100" src="uploads/category/<?php echo $row["category_img"]; ?>">
                                </a></td>
                           ...
                           <td>
                             <div class="dropdown ml-auto">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="updatecategory.php?updateid=<?php echo my_simple_crypt($row["category_id"],'e'); ?>">Edit</a>
                                                            <a data-id="<?php echo $row["category_id"]; ?>" data-toggle="modal" data-target="#basicModal" class="btn  open-dialog">Delete</a>
