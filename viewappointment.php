                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    {
                                        $result=mysqli_query($conn,"delete from tbl_appointment where app_id='".$_POST["deleteid"]."'");
                                    ...
                                    <table id="example3" class="display table-responsive-lg">
                                        ...
                                        <tbody>
                                            <?php
                          $count=1;
                           $result=mysqli_query($conn,"select a.*,u.fname,d.name,h.hospital_name from tbl_appointment as a left join tbl_userr as u on u.user_id=a.user_id left join tbl_doctor as d on d.doc_id=a.doc_id left join tbl_hospital as h on h.hospital_id=a.hospital_id") or die(mysqli_error($conn));
                            ...
                            <td>
                                                    <div class="dropdown ml-auto">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a data-id="<?php echo $row["app_id"]; ?>" data-toggle="modal" data-target="#basicModal" class="btn  open-dialog">Delete</a>
