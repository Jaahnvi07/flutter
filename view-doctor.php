        ...
        ***********************************-->
        			<div class="content-body">
                        ...
                        <tr>
                            ...
                            <td><?php echo $row["about_doctor"]; ?></td>
                            ...
                            <td>
                                                    <div class="d-flex">
                                                        <a href="updateadmin.php?updateid=<?php echo $row["doc_id"]; ?>"  class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                        <a data-id="<?php echo $row["doc_id"]; ?>" data-toggle="modal" data-target="#basicModal"  class="btn btn-danger shadow btn-xs sharp open-dialog"><i class="fa fa-trash"></i></a>
                                                    </div>                                              
                                                </td>
                        </tr>
