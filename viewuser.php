        			...
        			<div class="content-body">
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <button name="btnadd" type="button" onclick="window.location='adduser.php';" class="btn btn-rounded btn-primary"><span
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="example3" class="display table-responsive-lg">
                                        ...
                                        <tbody>
                                             <?php
                          $count=1;
                          $result=mysqli_query($conn,"select u.*,c.city_name from tbl_userr as u left join tbl_city as c on c.city_id=u.city_id") or die(mysqli_error($conn));
                            ...
                            <td>
                                                    <div class="dropdown ml-auto">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="updateuser.php?updateid=<?php echo my_simple_crypt($row["user_id"],'e'); ?>">Edit</a>
                                                            <a  data-id="<?php echo $row["user_id"]; ?>" data-toggle="modal" data-target="#basicModal" class="btn  open-dialog">Delete</a>
                                                            <a class="dropdown-item" href="viewuserdetail.php?updateid=<?php echo my_simple_crypt($row["user_id"],'e'); ?>">View Details</a>
                                                        </div>
                                                    </div>                                 
                                                </td>
                        </tr>
