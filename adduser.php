...
<div class="alert alert-danger alert-dismissible fade show">
                  ...
                  <button type="button" class="close h-100" data-dismiss="alert" aria-label="Close"><span><i class="mdi mdi-close"></i></span>
                    ...
                    <div class="form-group">
                       AadharCard Number<input type="text" id="txtaadharnum" name="txtaadharnum" class="form-control input-rounded" onBlur='checkanum()'>
                       <span class="error" id="lblanum"></span>
                    </div>
                    <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                       Latitude<input type="text" name="txtlatitude" class="form-control input-rounded">
                    </div>
                    <div class="form-group">
                      Longitude<input type="text" name="txtlongitude" class="form-control input-rounded">
                     </div>
                    ...
                    <div class="form-group">
                      OTP<input type="text" name="txtotp" class="form-control input-rounded">
                     </div>
                     <div class="form-group mb-0">
                    ...
                    <div class="form-group">
                       Blood Group<input type="text" name="txtbg" class="form-control input-rounded">
                    </div>
                    <div class="form-group">
                       Height<input type="text" name="txtheight" class="form-control input-rounded">
                    </div>
                 <div class="form-group">
                       Weight<input type="text" name="txtweight" class="form-control input-rounded">
                 </div>
       ...
       function checkanum()
    {
      ...
      $.ajax({
        ...
        success: function(res)
        {
          if(res.trim()=="true")
          {
            $("#lblanum").html("This aadharcard num already exist");
