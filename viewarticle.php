...
<head>
    ...
    <title>View Article - Admin</title>
    <!-- Favicon icon -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    {
                                        $result=mysqli_query($conn,"delete from tbl_article where ar_id='".$_POST["deleteid"]."'");
                           ...
                           $result=mysqli_query($conn,"select a.*,d.name from tbl_article as a left join tbl_doctor as d on d.doc_id=a.doc_id") or die(mysqli_error($conn));
