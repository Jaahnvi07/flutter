					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">State Detail</h4>
                                <button name="btnadd" type="button" onclick="window.location='addstate.php';" class="btn btn-rounded btn-primary"><span
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    {
                                        $result=mysqli_query($conn,"delete from tbl_state where state_id='".$_POST["deleteid"]."'");
                            ...
                            <td>
                                                    <div class="dropdown ml-auto">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="updatestate.php?updateid=<?php echo my_simple_crypt($row["state_id"],'e'); ?>">Edit</a>
                                                            <a data-id="<?php echo $row["state_id"]; ?>" data-toggle="modal" data-target="#basicModal" class="btn  open-dialog">Delete</a>
