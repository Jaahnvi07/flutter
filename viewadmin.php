        			...
        			<div class="content-body">
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <button name="btnadd" type="button" onclick="window.location='addadmin.php';" class="btn btn-rounded btn-primary"><span
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    {
                                        $result=mysqli_query($conn,"delete from tbl_admin where login_id='".$_POST["deleteid"]."'");
                        ...
                        <tr>
                            ...
                            <td>
                                <a target="_blank" href="uploads/profile/<?php echo $row["profile_pic"]; ?>">
                                    <img width="100" height="100" src="uploads/profile/<?php echo $row["profile_pic"]; ?>">
                                </a>
                            </td>
                            ...
                            <td>
                                                    <div class="dropdown ml-auto">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="updateadmin.php?updateid=<?php echo my_simple_crypt($row["login_id"],'e'); ?>">Edit</a>
                                                            <a data-id="<?php echo $row["login_id"]; ?>" data-toggle="modal" data-target="#basicModal" class="btn  open-dialog">    Delete</a>
                                                        </div>
                                                    </div>                                              
                                                </td>
                        </tr>
