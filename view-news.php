        ...
        ***********************************-->
        			<div class="content-body">
                        ...
                        <tr>
                           ...
                           <td>
                             <div class="d-flex">
                                <a href="updatenews.php?updateid=<?php echo $row["news_id"]; ?>" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                <a  data-id="<?php echo $row["news_id"]; ?>" data-toggle="modal" data-target="#basicModal" class="btn btn-danger shadow btn-xs sharp open-dialog"><i class="fa fa-trash"></i></a>
                             </div>
                           </td>
                        </tr>
