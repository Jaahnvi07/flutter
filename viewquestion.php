...
<head>
    ...
    <title>View Question - Admin</title>
    <!-- Favicon icon -->
        ...
        ***********************************-->
        			<div class="content-body">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    {
                                        $result=mysqli_query($conn,"delete from tbl_question where q_id='".$_POST["deleteid"]."'");
                                    ...
                                    <table id="example3" class="display table-responsive-lg">
                                        ...
                                        <tbody>
                                             <?php
                          $count=1;
                          $result=mysqli_query($conn,"select q.*,u.fname from tbl_question as q left join tbl_userr as u on u.user_id=q.user_id") or die(mysqli_error($conn));
                        ...
                        <tr>
                            ...
                            <td><?php echo $row["que_ask_datetime"]; ?></td>
