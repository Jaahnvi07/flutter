                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    ...
                                    //
                                		...
                                		$result = mysqli_query($conn,"insert into tbl_category (category_name,category_img,category_des) values ('".$_POST["txtname"]."','".$newname."','".$_POST["txtaddress"]."')") or die(mysqli_error($conn));
								...
								<div class="alert alert-danger alert-dismissible fade show">
                                    ...
                                    <form method="post" id="form1" enctype="multipart/form-data">
                                        ...
                                        Category name :
                                           <input type="text" name="txtname" class="form-control input-rounded" placeholder="Enter Category Name">
                                        </div>
                                        <div class="form-group">
                                            Category Image:<input type="file" name="categoryimg" class="form-control input-rounded" >
                                        </div>
                                         <div class="form-group">
                                            Category Address:<textarea class="form-control"  rows="4" id="comment" name="txtaddress" placeholder="Enter Address"></textarea>
                                        </div>
